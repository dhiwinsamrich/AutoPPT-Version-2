            ...
            if available_side_headings:
                ...
                if side_headings_to_generate:
                    ...
                    side_heading_templates = {
                        1: "Generate exactly 2-3 words that describe a key feature of the project. Examples: 'Scalable Solution', 'Real-Time', 'Secure Platform'. Output only the words, no explanations.",
                        2: "Generate exactly 2-3 words that describe another key feature of the project. Examples: 'Cloud-Native', 'AI-Powered', 'Data-Driven'. Output only the words, no explanations.",
                        3: "Generate exactly 2-3 words that describe a third key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        4: "Generate exactly 2-3 words that describe a fourth key feature of the project. Examples: 'Enterprise-Grade', 'Innovation-Driven', 'Scalable Platform'. Output only the words, no explanations.",
                        5: "Generate exactly 2-3 words that describe a fifth key feature of the project. Examples: 'Digital-First', 'Automated Workflow', 'Smart Analytics'. Output only the words, no explanations.",
                        6: "Generate exactly 2-3 words that describe a sixth key feature of the project. Examples: 'Agile Method', 'Best Practice', 'Modern Architecture'. Output only the words, no explanations.",
                        7: "Generate exactly 2-3 words that describe a seventh key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        8: "Generate exactly 2-3 words that describe a eighth key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        9: "Generate exactly 2-3 words that describe a ninth key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        10: "Generate exactly 2-3 words that describe a tenth key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        11: "Generate exactly 2-3 words that describe a eleventh key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        12: "Generate exactly 2-3 words that describe a twelfth key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        13: "Generate exactly 2-3 words that describe a thirteenth key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        14: "Generate exactly 2-3 words that describe a fourteenth key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                        15: "Generate exactly 2-3 words that describe a fifteenth key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations.",
                    }
                    ...
                    for i in side_headings_to_generate:
                        if i <= 6:
                            ...
                            prompt_text = f"Generate exactly 2-3 words that describe a {ordinal} key feature of the project. Output only the words, no explanations."
                ...
                for i in range(1, 16):
                    ...
                    if i == 1:
                        prompt_text = "Generate exactly 2-3 words that describe a key feature of the project. Examples: 'Scalable Solution', 'Real-Time', 'Secure Platform'. Output only the words, no explanations."
                    elif i == 2:
                        prompt_text = "Generate exactly 2-3 words that describe another key feature of the project. Examples: 'Cloud-Native', 'AI-Powered', 'Data-Driven'. Output only the words, no explanations."
                    elif i == 3:
                        prompt_text = "Generate exactly 2-3 words that describe a third key feature of the project. Examples: 'User-Friendly', 'Future-Ready', 'Performance-Optimized'. Output only the words, no explanations."
                    elif i <= 6:
                        ordinal_map = {4: "fourth", 5: "fifth", 6: "sixth"}
                        prompt_text = f"Generate exactly 2-3 words that describe a {ordinal_map[i]} key feature of the project. Examples: 'Enterprise-Grade', 'Innovation-Driven', 'Scalable Platform'. Output only the words, no explanations."
                    else:
                        prompt_text = f"Generate exactly 2-3 words that describe a {ordinal} key feature of the project. Output only the words, no explanations."
                    side_heading_prompts += f'    "side_Heading_{i}": "{prompt_text}",\n'
...
{preset_section}Generate ALL the following content in a single JSON response. Be specific, professional, and engaging:
 ...
 {{
    ...
    "Head1_para": "Based on '{{project_description}}' and 'Heading_1', write ONE clear sentence (15-20 words) explaining what we're trying to achieve with this goal. Focus on creating/building/showcasing specific aspects. Example: 'Create a platform that showcases teams, players and the energy of every match with storytelling'. Be concrete and action-oriented.",
    "Head2_para": "Based on '{{project_description}}' and 'Heading_2', write ONE clear sentence (15-20 words) explaining what we're trying to achieve with this goal. Focus on ensuring/enabling user experience across platforms/devices. Example: 'Ensure smooth navigation and real-time updates across mobile, tablet and desktop'. Be specific and user-focused.",
    "Head3_para": "Based on '{{project_description}}' and 'Heading_3', write ONE clear sentence (15-20 words) explaining what we're trying to achieve with this goal. Focus on allowing/enabling user actions, workflows, or processes. Example: 'Allow teams to register, create rosters and manage schedules without manual intervention'. Be process-oriented.",
    "Head4_para": "Based on '{{project_description}}' and 'Heading_4', write ONE clear sentence (15-20 words) explaining what we're trying to achieve with this goal. Focus on delivering/providing system capabilities, reliability, or performance. Be technical yet clear.",
    "Head5_para": "Based on '{{project_description}}' and 'Heading_5', write ONE clear sentence (15-20 words) explaining what we're trying to achieve with this goal. Focus on implementing/leveraging intelligent features, automation, or innovation. Be forward-thinking.",
    "Head6_para": "Based on '{{project_description}}' and 'Heading_6', write ONE clear sentence (15-20 words) explaining what we're trying to achieve with this goal. Focus on supporting/enabling growth, scalability, or long-term success. Be strategic.",
     
     "points_1": "Based on the project description and the feature 'side_Heading_1' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_1' or any individual words from 'side_Heading_1' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_2": "Based on the project description and the feature 'side_Heading_2' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_2' or any individual words from 'side_Heading_2' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_3": "Based on the project description and the feature 'side_Heading_3' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_3' or any individual words from 'side_Heading_3' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_4": "Based on the project description and the feature 'side_Heading_4' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_4' or any individual words from 'side_Heading_4' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_5": "Based on the project description and the feature 'side_Heading_5' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_5' or any individual words from 'side_Heading_5' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_6": "Based on the project description and the feature 'side_Heading_6' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_6' or any individual words from 'side_Heading_6' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_7": "Based on the project description and the feature 'side_Heading_7' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_7' or any individual words from 'side_Heading_7' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_8": "Based on the project description and the feature 'side_Heading_8' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_8' or any individual words from 'side_Heading_8' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_9": "Based on the project description and the feature 'side_Heading_9' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_9' or any individual words from 'side_Heading_9' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_10": "Based on the project description and the feature 'side_Heading_10' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_10' or any individual words from 'side_Heading_10' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_11": "Based on the project description and the feature 'side_Heading_11' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_11' or any individual words from 'side_Heading_11' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     ...
     "points_13": "Based on the project description and the feature 'side_Heading_13' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_13' or any individual words from 'side_Heading_13' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_14": "Based on the project description and the feature 'side_Heading_14' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_14' or any individual words from 'side_Heading_14' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     "points_15": "Based on the project description and the feature 'side_Heading_15' (value provided above in preset section), write EXACTLY 2 bullet points about this feature. Format: First bullet: Describe what the feature is and how it works in the project context (20-30 words). Second bullet: Explain the business impact, benefits, or user experience improvements from a different angle (20-30 words). CRITICAL RULE: NEVER include 'side_Heading_15' or any individual words from 'side_Heading_15' in your response. Write descriptive content about the feature WITHOUT repeating its name. Example: If heading is 'Secure Payments', do NOT write 'secure' or 'payments' anywhere. Output format:\\n Feature description and how it works\\n Business impact and benefits",
     
    "scope_desc": "Write a comprehensive scope description for '{project_name}' (40-50 words). Based on '{{project_description}}', outline: (1) What the project aims to build/deliver, (2) Key features and functionality elements (list 3-4 specific items), (3) Who it empowers/serves (target users), (4) Core benefits (real-time access, intuitive controls, scalability, etc.). Use professional PPT language. Example structure: 'This project aims to build a [type] that [streamlines/provides/enables] [key features]—empowering [users] with [benefits] and [capabilities].'",
...
"""
            ...
            self._record_token_usage(response, label="comprehensive_generation")
    ...
    def generate_image(self, placeholder_type, context="", company_name="", project_name="", project_description="", image_requirements=None, theme=None, placeholder_dimensions=None, reference_image_path=None, company_website=None):
        ...
        Args:
            ...
            company_website: URL of company website to extract logo from (optional)
        """
        try:
            # Special handling for company logos - generate exact company logo (including numbered variants)
            is_company_logo = placeholder_type.lower() == 'companylogo' or placeholder_type.lower().startswith('companylogo_')
            if placeholder_type in ['logo', 'companyLogo'] or is_company_logo:
                logo_path = self._generate_company_logo(company_name, context, placeholder_dimensions, company_website)
                return (logo_path, None, None) if logo_path else (None, None, None)
    ...
    def _process_logo_for_transparency(self, image):
        """Process logo to ensure transparent background and remove white padding"""
        try:
            ...
            for item in data:
                ...
                # Be more aggressive in removing light backgrounds
            ...
            self.logger.error(f"Error processing logo for transparency: {e}")
            return image

    def _generate_company_logo(self, company_name, context="", placeholder_dimensions=None, company_website=None):
        """Generate company logo using AI (company_website parameter kept for compatibility but not used)"""
        try:
            # Generate logo using AI only
            self.logger.info(f"Generating AI logo for {company_name}...")
            
            # Generate logo directly using Gemini without going through generate_image to avoid recursion
            logo_path = self._generate_logo_directly(company_name, context, placeholder_dimensions)
            
            if logo_path and os.path.exists(logo_path):
                self.logger.info(f"Successfully generated {company_name} logo: {logo_path}")
                return logo_path
            else:
                self.logger.error(f"AI logo generation failed for {company_name}")
                raise ValueError("AI logo generation failed")
                
        except Exception as e:
            self.logger.error(f"Error generating company logo: {e}")
            raise e

    def _generate_logo_directly(self, company_name, context, placeholder_dimensions=None):
        """Generate logo directly using Gemini without recursion with ultra-high clarity"""
        try:
            # Create enhanced prompt for ultra-clear logo generation
            dimension_info = ""
            if placeholder_dimensions:
                width = placeholder_dimensions.get('width', 400)
                height = placeholder_dimensions.get('height', 400)
                unit = placeholder_dimensions.get('unit', 'PT')
                dimension_info = f" {width}x{height} {unit}."
            
            # Simplified logo prompt
            enhanced_prompt = f"Professional company logo for {company_name}. Clean, modern, minimalist, high-resolution, vector-style, sharp edges.{dimension_info} TRANSPARENT background, NO padding, fill entire canvas edge-to-edge."
            
            self.logger.info(f"Generating ultra-clear logo with Gemini...")
            
            # Use Gemini's image generation model directly with timeout handling
            model = genai.GenerativeModel(self.image_model_name)
            ...
            for attempt in range(max_retries):
                try:
                    self.logger.info(f"Gemini API call attempt {attempt + 1}/{max_retries}")
                    response = model.generate_content(
                        enhanced_prompt,
                        generation_config={
                    ...
                    self._record_token_usage(response, label="logo_generation")
                    break  # Success, exit retry loop
                except Exception as e:
                    self.logger.warning(f"Gemini API call attempt {attempt + 1} failed: {e}")
                    if attempt == max_retries - 1:
                        raise e
                    # Wait before retry
                    import time
            ...
            if image_parts:
                ...
                # Convert to PIL Image and ensure supported format/size
                image = Image.open(BytesIO(image_data)).convert('RGBA')  # Use RGBA for better quality
                
                # Post-process to ensure transparent background and remove white padding
                image = self._process_logo_for_transparency(image)
                
                # Generate filename
                filename = f"companyLogo_{company_name.replace(' ', '_')}_{hash(enhanced_prompt) % 10000}.png"
                filepath = os.path.join("generated_images", filename)
                
                # Resize to EXACT placeholder dimensions with ultra-high quality
                if placeholder_dimensions and placeholder_dimensions.get('width') and placeholder_dimensions.get('height'):
                    target_width = int(placeholder_dimensions['width'])
                    target_height = int(placeholder_dimensions['height'])
                    
                    # Use LANCZOS resampling for ultra-clear resizing to EXACT dimensions
                    image = image.resize((target_width, target_height), Image.Resampling.LANCZOS)
                    
                    # Verify exact dimensions match
                    if image.width != target_width or image.height != target_height:
                        self.logger.warning(f"AI logo resize mismatch: got {image.width}x{image.height}, expected {target_width}x{target_height}")
                        image = image.resize((target_width, target_height), Image.Resampling.LANCZOS)
                    
                    self.logger.info(f"✅ AI logo resized to EXACT placeholder dimensions: {image.width}x{image.height} px (target: {target_width}x{target_height} PT)")
                else:
                    # Resize if overly large but maintain quality
                    max_width, max_height = 1920, 1920  # Square for logos
                    if image.width > max_width or image.height > max_height:
                        image.thumbnail((max_width, max_height), Image.Resampling.LANCZOS)
                
                # Save as PNG with maximum quality
                image.save(filepath, format='PNG', optimize=False, compress_level=0)  # No compression for maximum quality
                
                self.logger.info(f"Ultra-clear logo generated successfully: {filepath}")
                return os.path.abspath(filepath)
            else:
                self.logger.warning("No image data in response")
                return None
                
        except Exception as e:
            self.logger.error(f"Error generating logo directly: {e}")
            return None
